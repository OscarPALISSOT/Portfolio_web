...
const Navbar = ({links, logo}: NavbarProps) => {
    ...
    return (
        <>
            <div
                className={`hidden lg:flex transition duration-300 font-light bg-background font-roboto sticky top-0 2xl:px-64 2xl:-mx-64 -mx-24 px-24 flex-col justify-between z-50 ${scrollY > 3 && 'shadow-[0_6px_12px_0_rgba(0,0,0,0.12)] '}`}>
