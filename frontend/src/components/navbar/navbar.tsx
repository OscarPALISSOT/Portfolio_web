            ...
            <div
                ...
                <div className={'flex flex-row justify-between items-center h-24'}>
                    ...
                    <div className={'h-full flex'}>
                        <div className={'h-full border-l border-background dark:border-text flex items-center'}>
                            <ul className={'flex flex-row'}>
                                {links.map((link, index) => {
                                    return (
                                        <li key={index}
                                            className={`mx-4 relative h-8 before:content-[""] before:absolute before:w-px before:bottom-0 before:bg-background dark:before:bg-text before:transition-transform before:h-full before:-right-1 before:ease-out before:duration-300 before:origin-bottom-right before:scale-y-0 hover:before:scale-y-100 hover:before:origin-top-right ${currentSection === link && 'before:scale-y-100 before:origin-top-right'}`}>
